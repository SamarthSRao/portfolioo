...
import { List, X, Github, Linkedin, Twitter, Mail, ExternalLink, FileText } from "lucide-react";
  ...
  return (
    <div className="bg-[#0a0a0a] h-[100dvh] w-screen text-gray-200 font-sans overflow-x-hidden overflow-y-auto selection:bg-white/10 relative">
            ...
            >
              ...
              <div className="p-5 flex-1 overflow-y-auto font-mono text-sm space-y-6">
                <div className="space-y-4">
                  <a href="#work" onClick={() => setSidebarOpen(false)} className="flex items-center text-gray-400 hover:text-white transition-colors group">
                    <span className="text-gray-600 mr-2 group-hover:text-white transition-colors">{">"}</span> work
                  </a>
                  <a href="#projects" onClick={() => setSidebarOpen(false)} className="flex items-center text-gray-400 hover:text-white transition-colors group">
      ...
      <div className="px-4 py-2 pb-20">
        ...
        {/* We removed the redundant profile section since the avatar/name are in the navbar now. */}
        ...
        <div className="mb-12" id="work">
          <h2 className="text-lg font-bold mb-5 font-sans text-white">Experience</h2>
          <div className="space-y-4">
            ...
            <button className="w-full py-3 mt-2 bg-[#111] border border-white/5 text-gray-400 font-medium text-[13px] rounded-xl hover:bg-white/5 transition-colors">
        ...
        <div className="mb-14" id="projects">
          <h2 className="text-lg font-bold mb-5 font-sans text-white">Selected Projects</h2>
